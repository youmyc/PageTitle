...
public class YMPageContentView: UIView {
    ...
    public weak var delegate : YMPageContentViewDelegate?
    ...
    fileprivate lazy var collectionView : UICollectionView = {[weak self] in
        ...
        collectionView.backgroundColor = UIColor(valueRGB: 0xf5f6f7, alpha: 1)
...
extension YMPageContentView : UICollectionViewDataSource {
