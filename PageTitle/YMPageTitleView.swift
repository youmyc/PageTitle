...
// MARK:- 定义协议
public protocol YMPageTitleViewDelegate : class {
...
public class YMPageTitleView: UIView {
    fileprivate var currentIndex : Int = 0
    fileprivate var titles : [String]
    public weak var delegate : YMPageTitleViewDelegate?
    ...
    ///   - frame: CGRect
    ///   - titles: 标题数组
    ///   - params: 元组(长：CGFloat，宽：CGFloat，字体：UIFont)
    ///   - count: <#count description#>
    public init(frame: CGRect, titles:[String], params:(CGFloat,CGFloat,UIFont) = (50,2,UIFont.boldSystemFont(ofSize: 14)), count:Int = 3) {
        self.titles = titles
...
//        let labelW : CGFloat = 120
        ...
        scrollView.contentSize = CGSize(width: labelW * CGFloat(titles.count), height: bounds.height)
...
extension YMPageTitleView {
    ...
    ///   - sourceIndex: 源标题
    ///   - targetIndex: 目标标题
    public func setTitleWithProgress(_ progress : CGFloat, sourceIndex : Int, targetIndex : Int) {
